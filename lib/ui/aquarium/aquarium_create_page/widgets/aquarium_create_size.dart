...
class AquariumCreateSize extends ConsumerWidget {
  const AquariumCreateSize({super.key});
                  ...
                  SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      onChanged: (String size) {
                        ref.read(aquariumCreateProvider.notifier).notifySize1(size);
                        // setState(() {});
                      },
                    ),
                  ),
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      onChanged: (String size) {
                        ref.read(aquariumCreateProvider.notifier).notifySize2(size);
                        // setState(() {});
                      },
                    ),
                  ),
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      onChanged: (String size) {
                        ref.read(aquariumCreateProvider.notifier).notifySize3(size);
                        // setState(() {});
                      },
                    ),
                  ),
