...
class AquariumCreateButton extends ConsumerWidget {
  final _formKey;

  const AquariumCreateButton(this._formKey, {super.key});
    ...
    return ElevatedButton(
      onPressed: () async {
        ...
        if (_formKey.currentState!.validate()) {
          ...
          await ref.watch(mainProvider.notifier).notifyAquariumCreate(aquariumRequestDTO, imageFile);
        }
      },
