...
class ScheduleDTO {
  ...
  @override
  String toString() {
    return 'ScheduleDTO{id: $id, aquariumId: $aquariumId, aquariumTitle: $aquariumTitle, title: $title, scheduleEnum: $scheduleEnum, isCompleted: $isCompleted, betweenDay: $betweenDay, targetDay: $targetDay, createdAt: $createdAt, updatedAt: $updatedAt}';
  }
}
